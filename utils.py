...
def Inference(spin, strain_L1, strain_H1, strain_V1):
    if spin:
        models = ['/root/capsule/data/trained_models/model_spin_2.h5','/root/capsule/data/trained_models/model_spin_4.h5','/root/capsule/data/trained_models/model_spin_3.h5','/root/capsule/data/trained_models/model_spin_1.h5']
        string = 'Spin'
    else:
        models = ['/root/capsule/data/trained_models/model_non_spin_1.h5','/root/capsule/data/trained_models/model_non_spin_3.h5', '/root/capsule/data/trained_models/model_non_spin_4.h5','/root/capsule/data/trained_models/model_non_spin_2.h5']
        string = 'Non-Spin'
